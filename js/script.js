...
document.getElementsByClassName('main__buttons__play')[0].addEventListener('click', function play() {
  ...
  var quiz5 = ['js', 'Cosa pensa Chiara quando Alessandro, per la 800esima volta fa: "Posso chiedere una cosa?"','Evvai, non vedevo l\'ora!','Sono veramente euforico', 'Che bravo giovanotto','Le rose son rosse, le viole son blu, minchia vuoi di nuovo tu?','Le rose son rosse, le viole son blu, minchia vuoi di nuovo tu?'];
